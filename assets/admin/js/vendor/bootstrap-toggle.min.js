...
+ function(a) {
    ...
    c.VERSION = "2.2.0", c.DEFAULTS = {
        ...
        var b = "large" === this.options.size ? "btn-lg" : "small" === this.options.size ? "btn-sm" : "mini" === this.options.size ? "btn-xs" : "",
            ...
            g = a('<div class="toggle btn" data-bs-toggle="toggle">').addClass(this.$element.prop("checked") ? this._onstyle : this._offstyle + " off").addClass(b).addClass(this.options.style);
    ...
    }), a(document).on("click.bs.toggle", "div[data-bs-toggle^=toggle]", function(b) {
