! function(e) {
    ...
    e.defineMode("css", function(t, r) {
        ...
        function j(e, t) {
            return e.next(), e.match(/^\s*[\"\')]/, !1) ? t.tokenize = null : t.tokenize = z(")"), x(null, "(")
        }
        ...
        function q(e, t, r, o) {
            return e.context = new P(r, t.indentation() + (!1 === o ? 0 : n), e.context), r
        }
        ...
        function _(e) {
            ...
            a = f.hasOwnProperty(t) ? "atom" : h.hasOwnProperty(t) ? "keyword" : "variable"
        }
        var T = {
            top: function(e, t, r) {
            ...
            block: function(e, t, r) {
                if ("word" == e) {
                    ...
                    return u.hasOwnProperty(o) ? (a = "property", "maybeprop") : m.hasOwnProperty(o) ? (a = v ? "string-2" : "property", "maybeprop") : k ? (a = t.match(/^\s*:(?:\s|$)/, !1) ? "property" : "tag", "block") : (a += " error", "maybeprop")
                }
                return "meta" == e ? "block" : k || "hash" != e && "qualifier" != e ? T.top(e, t, r) : (a = "error", "block")
            },
            ...
            propBlock: function(e, t, r) {
                return "}" == e ? K(r) : "word" == e ? (a = "property", "maybeprop") : r.context.type
            },
            parens: function(e, t, r) {
                return "{" == e || "}" == e ? B(e, t, r) : ")" == e ? K(r) : "(" == e ? q(r, t, "parens") : "interpolation" == e ? q(r, t, "interpolation") : ("word" == e && _(t), "parens")
            },
            pseudo: function(e, t, r) {
                return "meta" == e ? "pseudo" : "word" == e ? (a = "variable-3", r.context.type) : C(e, t, r)
            },
            documentTypes: function(e, t, r) {
                return "word" == e && s.hasOwnProperty(t.current()) ? (a = "tag", r.context.type) : T.atBlock(e, t, r)
            },
            atBlock: function(e, t, r) {
                if ("(" == e) return q(r, t, "atBlock_parens");
                if ("}" == e || ";" == e) return B(e, t, r);
                if ("{" == e) return K(r) && q(r, t, k ? "block" : "top");
                if ("interpolation" == e) return q(r, t, "interpolation");
                if ("word" == e) {
                    var o = t.current().toLowerCase();
                    a = "only" == o || "not" == o || "and" == o || "or" == o ? "keyword" : d.hasOwnProperty(o) ? "attribute" : c.hasOwnProperty(o) ? "property" : p.hasOwnProperty(o) ? "keyword" : u.hasOwnProperty(o) ? "property" : m.hasOwnProperty(o) ? v ? "string-2" : "property" : f.hasOwnProperty(o) ? "atom" : h.hasOwnProperty(o) ? "keyword" : "error"
                }
                return r.context.type
            },
            atComponentBlock: function(e, t, r) {
                return "}" == e ? B(e, t, r) : "{" == e ? K(r) && q(r, t, k ? "block" : "top", !1) : ("word" == e && (a = "error"), r.context.type)
            },
            atBlock_parens: function(e, t, r) {
                return ")" == e ? K(r) : "{" == e || "}" == e ? B(e, t, r, 2) : T.atBlock(e, t, r)
            },
            restricted_atBlock_before: function(e, t, r) {
                return "{" == e ? q(r, t, "restricted_atBlock") : "word" == e && "@counter-style" == r.stateArg ? (a = "variable", "restricted_atBlock_before") : C(e, t, r)
            },
            restricted_atBlock: function(e, t, r) {
                return "}" == e ? (r.stateArg = null, K(r)) : "word" == e ? (a = "@font-face" == r.stateArg && !b.hasOwnProperty(t.current().toLowerCase()) || "@counter-style" == r.stateArg && !g.hasOwnProperty(t.current().toLowerCase()) ? "error" : "property", "maybeprop") : "restricted_atBlock"
            },
            keyframes: function(e, t, r) {
                return "word" == e ? (a = "variable", "keyframes") : "{" == e ? q(r, t, "top") : C(e, t, r)
            },
            at: function(e, t, r) {
                return ";" == e ? K(r) : "{" == e || "}" == e ? B(e, t, r) : ("word" == e ? a = "tag" : "hash" == e && (a = "builtin"), "at")
            },
            interpolation: function(e, t, r) {
                return "}" == e ? K(r) : "{" == e || ";" == e ? B(e, t, r) : ("word" == e ? a = "variable" : "variable" != e && "(" != e && ")" != e && (a = "error"), "interpolation")
            }
        };
        return {
            startState: function(e) {
                return {
                    ...
                    state: o ? "block" : "top",
                    stateArg: null,
                    context: new P(o ? "block" : "top", e || 0, null)
                }
            },
            token: function(e, t) {
                ...
                return r && "object" == typeof r && (i = r[1], r = r[0]), a = r, "comment" != i && (t.state = T[t.state](i, e, t)), a
            },
            indent: function(e, t) {
                var r = e.context,
                    o = t && t.charAt(0),
    ...
    var r = ["domain", "regexp", "url", "url-prefix"],
        ...
        l = t(n),
        s = ["landscape", "portrait", "none", "coarse", "fine", "on-demand", "hover", "interlace", "progressive", "dark", "light"],
        d = t(s),
        ...
        m = t(u),
        b = t(["font-display", "font-family", "src", "unicode-range", "font-variant", "font-feature-settings", "font-stretch", "font-weight", "font-style"]),
        ...
        y = t(k),
        w = r.concat(i).concat(n).concat(s).concat(c).concat(u).concat(h).concat(k);
